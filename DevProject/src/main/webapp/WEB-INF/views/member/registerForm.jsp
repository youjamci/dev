...
<body>
	...
	<form action="/register01" method="post">
		...
		coin : <input type="text" name="coin" value="100"> <input
			type="submit" value="전송">
	</form>

	<p>4) 4) HTML 폼 필드가 여러 개일 경우에 컨트롤러 매개변수의 위치는 상관없다</p>
	...
	<p>5) HTML Form 필드값이 숫자일 경우에는 컨트롤러 매개변수 타입이 문자열이면 그대로 문자열 형태로 요청
		데이터를 취득한다.</p>
	...
	<p>1) URL 경로 상의 경로 변수가 여러 개일 경우, @PathVariable 어노테이션을 사용해 특정한 경로
		변수명을 지정해준다.</p>
	...
	<p>3) @RequestParam 어노테이션을 사용해 특정한 HTML Form의 필드명을 지정하여 요청을 처리한다.</p>
	...
	<p>8) 복수 선택이 가능한 폼 셀렉트 박스 요소값으 문자열 요소를 가진 리스트 컬렉션 타입 매개변수로 처리한다.</p>
	...
	<form action="/registerAddress" method="post">
		...
		location : <input type="text" name="location"> <br><!--  한글 안됨 -->
		<input type="submit" value="전송"/>
	</form><br>
	...
	<form action="/registerUserAddress" method="post">
		...
		location : <input type="text" name="address.location"> <br><!--  한글 안됨 -->
		<input type="submit" value="전송"/>
	</form><br>
	...
	<p>5) 여러 개의 파일 업로드 폼 파일 요소값을 여러 개의 MultipartFile 매개변수로 처리한다.</p>
	...
	<p>6) 여러 개의 파일 업로드를 폼 파일 요소값을 MultipartFile 타입의 요소를 가진 리스트 컬렉션 타입 매개변수로 처리한다.</p>
	...
	<p>7) 여러 개의 파일업로드 폼 파일 요소 값과 텍스트 필드 요소 값을 MultiFileMember 타입의 자바빈즈 매개변수로 처리한다.</p>
