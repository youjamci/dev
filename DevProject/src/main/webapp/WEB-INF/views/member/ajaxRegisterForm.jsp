...
<body>
	...
	<p>1) URL 경로 상의 여러 개의 경로 변수값ㅇ르 @PathVariable 어노테이션을 지정하여 여러 개의 문자열 매개변수로 처리한다.</p>
	<button id="registerBtn01">Register01</button> 
	
	<p>2) 객체 타입의 JSON 요청 데이터를 @RequestBody 어노테이션을 지정해 자바빈즈 매개변수로 처리한다.</p>
	...
	<p>6) 중첩된 객체 타입의 JSON 요청 데이ㅣ터를 @RequestBody 어노테이션을 지정하여 중첩된 자바빈즈 매개변수로 처리한다.</p>
