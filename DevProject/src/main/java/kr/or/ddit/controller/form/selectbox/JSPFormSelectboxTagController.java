...
public class JSPFormSelectboxTagController {
	...
	// 3) 모델에 CdoeLabelValue 타입의 요소를 가지는 List 타입의 데이터를 생성하여 추가한 후에 화면에 전달한다.
...
//		model.addAttribute("member", member); 없어도 'registerFormSelectboxResult(Member member' 때문에 넘어감
