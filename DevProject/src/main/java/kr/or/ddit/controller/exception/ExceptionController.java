...
public class ExceptionController {
	 ...
	 * 
	 * 		/// 메인으로 간다던, 내가 사용하던 페이지로 간다던지 등의 루틴
	 * 		1-1) 예외 종류
	 * 		- 스프링 프레임워크 예외
	 * 		- 사용자 정의 예외
	 * 		- 의존 라이브러리에서 발생한 예외
	 ...
	 * 				> Http Status 500
	 * 				> [예외 상황 만들 위치]
	 * 					sqlmap/boardMapper_SQL.xml id가 delete인 쿼리에서 board_no를 board_no2로 수정
	 * 				> [요청 URL]
	 * 					/crud/board/delete?boardNo=48 (post)
	 * 
	 ...
	 * 			> 입력값 검증 대상인 자바빈즈 메소드 매개변수에 @Validated를 지정하고 바로 다음에 BindingResult를 정의한다.
